...
function! dapper#model#ThreadsCache#new() abort
  let l:new = {
    \ '_ids_to_threads': {},
    \ 'TYPE': {'ThreadsCache': 1},
    \ 'get': function('dapper#model#ThreadsCache#get'),
    \ 'update': function('dapper#model#ThreadsCache#update'),
  \ }
  return l:new
endfunction

function! dapper#model#ThreadsCache#CheckType(object) abort
...
function! dapper#model#ThreadsCache#get(thread_id) abort dict
  call dapper#model#ThreadsCache#CheckType(l:self)
...
function! dapper#model#ThreadsCache#update(thread_id, new_props) abort dict
  call dapper#model#ThreadsCache#CheckType(l:self)
